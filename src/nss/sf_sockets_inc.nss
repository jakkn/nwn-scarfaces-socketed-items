...
const int MAX_DAMAGE_RESISTANCE = 10; // XX/-

// Maximum Regeneration Bonus allowed on armour type items
// Do NOT set this higher than 20
const int MAX_REGENERATION = 20;
